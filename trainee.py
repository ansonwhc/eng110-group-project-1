...
class Trainee:
    ...
    def generate_new_trainees(self):
        ...
        generated_trainees = {"Java": 0, "C#": 0, "Data": 0, "DevOps": 0, "Business": 0}

        # Randomly assigns students to courses.
        for i in range(num):
            course = random.randint(1, 5)
            if course == 1:
                generated_trainees['Java'] += 1
            elif course == 2:
                generated_trainees['C#'] += 1
            elif course == 3:
                generated_trainees['Data'] += 1
            elif course == 4:
                generated_trainees['DevOps'] += 1
            elif course == 5:
                generated_trainees['Business'] += 1
        
        return generated_trainees